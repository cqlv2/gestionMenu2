delete from fk_plat_produit;
delete from menu;
delete from produit;
delete from conditionnement;
delete from plat;

alter table fk_plat_produit AUTO_INCREMENT=0;
alter table menu AUTO_INCREMENT=0;
alter table produit AUTO_INCREMENT=0;
alter table conditionnement AUTO_INCREMENT=0;
alter table plat AUTO_INCREMENT=0;
	


INSERT INTO packaging 
(packaging, 	 	weight,		 unit) VALUES 
('PAQUET', 			'1000',		'GRAMME'), 
('POT', 			'250', 		'GRAMME'), 
('BOITE', 			'1200',		'GRAMME'), 
('POT', 			'0,250', 	'LITRE'), 
...
INSERT INTO menu 
(couvert_midi1, couvert_midi2, couvert_soir1, couvert_soir2, date, midi_1, midi_2, soir_1, soir_2, id_member) VALUES 
('2', '3', 	'5', NULL, '2020-10-22', '1', '2', 	'3', NULL,1),
('2', NULL, '5', NULL, '2020-10-23', '4', NULL, '1', NULL,2),
('2', NULL, '5', NULL, '2020-10-24', '1', NULL, '2', NULL,2),
('2', NULL, '5', NULL, '2020-10-25', '2', NULL, '3', NULL,2),
('2', NULL, '5', NULL, '2020-10-26', '3', NULL, '4', NULL,4),
('2', '3', 	'5', NULL, '2020-10-27', '2', '4', 	'1', NULL,4),
('2', NULL, '5', NULL, '2020-10-28', '3', NULL, '2', NULL,5),
('2', NULL, '5', NULL, '2020-10-29', '1', NULL, '3', NULL,5);